package aplicacion1.java;
public class Aplicacion1Java {
    public static void main(String[] args) {
        System.out.println("este es mi primer programa en JAVA");
    /*    int n1 = 12;
        double n2;
        n2 = 10.345;
        String apellido = "Pedro VArgas";
        char c = 'R' ;
        double n3 = n1;
        String m = "17";
        double promedio = (n1 + n2 ) / 2;
        System.out.println("promedio="+promedio);
        System.out.println("promedio2="+(Double.valueOf(n1)+n2) /2); 
        System.out.println("promedio3="+(n1+Double.valueOf(n3))/2);
        System.out.println("promedio3="+(n1+n3*1)/2);
        */
     /*int a = 2;
        double b = 3.0;
